...
namespace BdLab2Infrastructure.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public DepartmentsController(ScienceArchiveContext context)
        {
            _context = context;
        }
        ...
        {
            var scienceArchiveContext = _context.Departments.Include(d => d.Organization);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,OrganizationId")] Department department)
        {
            ...
            ViewData["OrganizationId"] = new SelectList(_context.Organizations, "Id", "Name", department.OrganizationId);
            return View(department);
        }
